...
class AppController:
    ...
    def draw_plots(self):
        ...
        # Define qual arquivo desenhar.
        # Prioridade: O arquivo "ativo" (clicado por último). 
        # Se não houver, pega o primeiro da lista de plots.
        ...
        if not filename_to_plot or filename_to_plot not in self.loaded_files:
            # Se não tem arquivo selecionado, talvez limpar o gráfico?
    ...
    def add_active_file_to_plot(self):
        ...
        """
        print("entrou em add_active_file_to_plot")
